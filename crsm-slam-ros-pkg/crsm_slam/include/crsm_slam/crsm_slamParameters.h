...
namespace crsm_slam
{
  ...
  struct CrsmSlamParameters
  {
    ...
    std::string dynamic_occupancy_grid_publish_topic; //!< The dynamic occupancy grid publishing topic
    std::string markers_publish_topic; //!< The markers publishing topic for the dynamic objects
    ...
    std::string pose_publish_topic; //!< The pose publish topic
