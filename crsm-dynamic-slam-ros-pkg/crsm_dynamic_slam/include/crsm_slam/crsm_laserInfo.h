...
namespace crsm_slam
{
  ...
  struct CrsmLaserInfo
  {
    ...
    double laserMin; //!< The minimum nominal laser distance [meters]
    double laserMax; //!< The maximum nominal laser distance [meters]
    double laserAngle; //!< The total laser angle
    double laserAngleBegin; //!< The minimum rays' angle
    double laserAngleEnd; //!< The maximum rays' angle
  };
}
