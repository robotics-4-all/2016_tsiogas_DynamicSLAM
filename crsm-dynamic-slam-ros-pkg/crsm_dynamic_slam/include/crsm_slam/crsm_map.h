...
#include <crsm_slam/crsm_mapInfo.h>
...
namespace crsm_slam
{
  ...
  class CrsmMap
  {
    public:
      ...
      //!< The container of the CRSM SLAM map. Each cell holds an occupancy probability.
      //!< In the specific implementation 0 states an occupied pixel and 255 a free one.
      unsigned char** p;
      ...
      /**
        @brief Reallocates the map to a specific direction
        @param exp [crsm_slam::CrsmExpansion] The expansion to be made
        @return void
       **/
